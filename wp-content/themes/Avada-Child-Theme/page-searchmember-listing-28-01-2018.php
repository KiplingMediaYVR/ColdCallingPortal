                    ...
                    <ul class="call-list call-list-full">
                        ...
                        <li>
                            ...
                            <div class="call-dtc">
                                ...
                                <h3><?php echo $user_info->txt_Brokerage; ?><br/><?php echo $user_info->billing_city; ?> | <?php echo $user_info->billing_state; ?> | <?php echo $user_info->billing_postcode; ?> | <?php echo $user_info->billing_country; ?></h3>
