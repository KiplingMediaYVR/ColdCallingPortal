                        ...
                        <div class="user_profile">
                            <div class="act_user">
                                <ul class="list-inline">
                                    <li class="dropdown">
                                        <?php echo $current_user->user_login; ?> <span class="user-icon"><i aria-hidden="true" class="fa fa-user-circle-o"></i></span>
									<?php $url = get_site_url(); ?>
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="<?php echo $url.'/my-account/edit-account/'; ?>"> My Profile</a>
                                            </li>
                                            <li>												
