...
{ 	
	$myId = $_GET['del'];
	$wpdb->query('DELETE  FROM wp_customuserlist WHERE ID = "'.$myId.'"');
    $location = get_site_url()."/myrefferal-listing";	
                    ...
                    <ul class="call-list call-list-full">
                        ...
                        <li>
                            ...
                            <div class="call-dtc">
                                ...
                                <a href="<?php echo get_site_url()."/myrefferal-listing?del=".$user->ID; ?>" class="trash" onclick="return confirm('Are you sure to delete this refferals request?!');">
