 ...
 * Edit account form
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/myaccount/class-wc-form-handler.php
 *
...
class WC_Form_Handler {
	...
	public static function save_account_details() {
		...
		if ( wc_notice_count( 'error' ) === 0 ) {
			...
			//wp_redirect( 'http://youmewebs.com/demo/cold-calling/my-account/edit-account/' );
			exit;
		}
	}
