<?php
	 ...
	 */
	class FusionRedux_Customizer_Panel extends WP_Customize_Panel {
		...
		protected function render_fallback() {
			$classes = 'accordion-section fusionredux-main fusionredux-panel control-section control-panel control-panel-' . esc_attr($this->type);
			?>
		...
		protected function render_content() {
			?>
			<li class="panel-meta accordion-section fusionredux-panel fusionredux-panel-meta control-section<?php if ( empty( $this->description ) ) {
				echo ' cannot-expand';
			} ?>">
