<?php
	// <input type="radio" value="1" name="_customize-radio-fusionredux_demo[opt-radio]" data-customize-setting-link="fusionredux_demo[opt-color-title]">
//return;
	/**
...
// Don't duplicate me!
	if ( ! class_exists( 'FusionReduxFramework_extension_customizer' ) ) {

		/**
		 * Main FusionReduxFramework customizer extension class
		 *
		 * @since       1.0.0
		 */
		class FusionReduxFramework_extension_customizer {

			// Protected vars
			protected $fusionredux;
			...
			public function __construct( $parent ) {
				...
				$this->upload_dir = FusionReduxFramework::$_upload_dir . 'advanced-customizer/';
				$this->upload_url = FusionReduxFramework::$_upload_url . 'advanced-customizer/';
				...
				// Override the FusionReduxCore class
				add_filter( "fusionredux/extension/{$this->parent->args['opt_name']}/customizer", array(
					$this,
				...
				if ( empty( $this->_extension_dir ) ) {
					$this->_extension_dir = FusionRedux_Helpers::get_extension_dir( dirname( __FILE__ ) );
					$this->_extension_url = FusionRedux_Helpers::get_extension_url( dirname( __FILE__ ) );
				}
				...
				if ( isset( $_POST['wp_customize'] ) && $_POST['wp_customize'] == "on" && isset( $_POST['customized'] ) && ! empty( $_POST['customized'] ) && ! isset( $_POST['action'] ) ) {
					add_action( "fusionredux/options/{$this->parent->args['opt_name']}/options", array(
						$this,
						'_override_values'
					), 100 );
				}
			...
			function enqueue_controls_css() {
				...
				require_once wp_normalize_path( FusionReduxFramework::$_dir . 'core/enqueue.php' );
				$enqueue = new fusionreduxCoreEnqueue ( $this->parent );
				$enqueue->get_warnings_and_errors_array();
				$enqueue->init();
				wp_enqueue_style( 'fusionredux-extension-advanced-customizer', $this->_extension_url . 'extension_customizer.css', '', time() );

				wp_enqueue_script(
					'fusionredux-extension-customizer',
					$this->_extension_url . 'extension_customizer' . FusionRedux_Functions::isMin() . '.js',
					array( 'jquery', 'fusionredux-js' ),
					FusionReduxFramework_extension_customizer::$version,
					true
				);
				wp_localize_script( 'fusionredux-extension-customizer', 'fusionredux_customizer', array( 'body_class' => sanitize_html_class( 'admin-color-' . get_user_option( 'admin_color' ), 'fresh' ) ) );
			}
			...
			function customize_preview_init() {
				do_action( 'fusionredux/customizer/live_preview' );
			}
			...
			public function _enqueue_new() {
				...
				/*
				  wp_enqueue_script('fusionredux-extension-customizer-codemirror-js', $this->_extension_url . 'new/codemirror.min.js');
				  wp_enqueue_script('fusionredux-extension-customizer-color-js', $this->_extension_url . 'new/colors-control.js');
				  wp_enqueue_script('fusionredux-extension-customizer-controls-js', $this->_extension_url . 'new/customizer-control.js');
				  wp_enqueue_script('fusionredux-extension-customizer-fonts-js', $this->_extension_url . 'new/fonts-customizer-admin.js');
				  wp_enqueue_script('fusionredux-extension-customizer-header-js', $this->_extension_url . 'new/header-control.js');
				  wp_enqueue_script('fusionredux-extension-customizer-models-js', $this->_extension_url . 'new/header-models.js');
				  wp_enqueue_script('fusionredux-extension-customizer-slimscroll-js', $this->_extension_url . 'new/jquery.slimscroll.js');
				  wp_enqueue_script('fusionredux-extension-customizer-droppable-js', $this->_extension_url . 'new/jquery.ui.droppable.min.js');
				  wp_enqueue_script('fusionredux-extension-customizer-editor-js', $this->_extension_url . 'new/media-editor.min.js');
				  wp_enqueue_script('fusionredux-extension-customizer-new-js', $this->_extension_url . 'new/new-customizer.js');
				  wp_enqueue_script('fusionredux-extension-customizer-previewing-js', $this->_extension_url . 'new/previewing.js');
				  wp_enqueue_script('fusionredux-extension-customizer-theme-js', $this->_extension_url . 'new/theme-customizer.js');
				 */
			}

			public function render( $control ) {
				$fieldID = str_replace( $this->parent->args['opt_name'] . '-', '', $control->fusionredux_id );
			...
			public function _register_customizer_controls( $wp_customize ) {
				...
				if ( ! class_exists( 'FusionRedux_Customizer_Section' ) ) {
					require_once wp_normalize_path( dirname( __FILE__ ) . '/inc/customizer_section.php' );
					if ( method_exists( $wp_customize, 'register_section_type' ) ) {
						$wp_customize->register_section_type( 'FusionRedux_Customizer_Section' );
					}
				}
				if ( ! class_exists( 'FusionRedux_Customizer_Panel' ) ) {
					require_once wp_normalize_path( dirname( __FILE__ ) . '/inc/customizer_panel.php' );
					if ( method_exists( $wp_customize, 'register_panel_type' ) ) {
						$wp_customize->register_panel_type( 'FusionRedux_Customizer_Panel' );
					}
				}
				if ( ! class_exists( 'FusionRedux_Customizer_Control' ) ) {
					require_once wp_normalize_path( dirname( __FILE__ ) . '/inc/customizer_control.php' );
				}

				require_once wp_normalize_path( dirname( __FILE__ ) . '/inc/customizer_fields.php' );
				require_once wp_normalize_path( dirname( __FILE__ ) . '/inc/customizer_devs.php' );

				do_action( "fusionredux/extension/customizer/control/includes" );

				//if ($this->parent->args['dev_mode']) {
				//    $section = new FusionRedux_Customizer_rAds( $wp_customize, 'fusionredux_rAds', array(
				//        'priority'    => 0,
				//    ) );
				...
				//    ) );
				//
				//    //$wp_customize->add_control( new FusionRedux_Customizer_Control_rAds( $wp_customize, 'fusionreduxAdsDisplay', array(
				//    //    'section'        => 'fusionredux_rAds',
				//    //    'settings'       => 'fusionredux_rAds_field',
				//    //    'type'           => 'fusionredux-rAds',
				//    //) ) );
				//
				//
				//
				...
				if ( $this->parent->args['dev_mode'] ) {
					...
					//    'priority'    => 0,
					//);
					////$section = new FusionRedux_Customizer_Section( $wp_customize, 'fusionredux_rAds', $args );
					////$wp_customize->add_section( $section, $args );
					//$this->add_section( 'fusionredux_rAds', array(
					//    'title'       => '',
					//    'priority'    => 1,
					//    'description' => '',
					...
					//    $wp_customize,
					//    'fusionredux_rAds_display',
					//    array(
					//        'section'    => 'fusionredux_rAds',
					//        'settings'   => 'fusionredux_rAds_display',
					//    )
					//));
					////$wp_customize->add_control( new FusionRedux_Customizer_Control_rAds( $wp_customize, 'fusionreduxAdsDisplay', array(
					////    'section'        => 'fusionredux_rAds',
					...
					//$section = new FusionRedux_Customizer_section_rAds( $wp_customize, 'fusionredux_rAds', array(
					//    'priority'    => -999,
					//) );
					//$wp_customize->add_section( $section, array(
					//    'priority'    => -999,
					...
					//    'fusionredux_rAds_empty'
					//);
					//$wp_customize->add_control(
					//    new FusionRedux_Customizer_Control_rAds(
					//        $wp_customize,
					//        'fusionredux_rAds_empty',
					//        array(
					//            'section'    => 'fusionredux_rAds',
					//            'settings'   => 'fusionredux_rAds_empty'
					//        )
					//    )
					//);
				}
				...
				foreach ( $this->parent->sections as $key => $section ) {
					...
					foreach ( $section['fields'] as $skey => $option ) {
						...
						add_action( 'fusionredux/advanced_customizer/control/render/' . $this->parent->args['opt_name'] . '-' . $option['id'], array(
							$this,
							'render'
						) );
						...
						$class_name = 'FusionRedux_Customizer_Control_' . $option['type'];

						do_action( 'fusionredux/extension/customizer/control_init', $option );
						...
						$wp_customize->add_control( new $class_name( $wp_customize, $option['id'], array(
							...
							'section'        => $section['id'],
							'settings'       => $option['id'],
							'type'           => 'fusionredux-' . $option['type'],
							'field'          => $option,
							'FusionReduxFramework' => $this->parent,
						...
						add_action( 'fusionredux/advanced_customizer/render/' . $option['id'], array(
							$this,
							'field_render'
						), $option['priority'] );
			...
			public function add_section( $id, $args = array(), $wp_customize ) {
				...
				if ( is_a( $id, 'WP_Customize_Section' ) ) {
					...
					$section_class = apply_filters( 'fusionredux/customizer/section/class_name', "FusionRedux_Customizer_Section" );
			...
			public function add_panel( $id, $args = array(), $wp_customize ) {
				if ( is_a( $id, 'WP_Customize_Panel' ) ) {
					...
					$panel_class = apply_filters( 'fusionredux/customizer/panel/class_name', "FusionRedux_Customizer_Panel" );
			...
			public function customizer_save_after( $wp_customize ) {
				...
				if ( $changed ) {
					...
					if ( $compiler ) {
						...
						do_action( "fusionredux/options/{$this->parent->args['opt_name']}/compiler", $this->parent->options, $this->parent->compilerCSS );
						do_action( "fusionredux/options/{$this->args['opt_name']}/compiler/advanced", $this->parent );
					}
				}
			...
			public function _enqueue_previewer() {
				wp_enqueue_script(
					'fusionredux-extension-previewer-js',
			...
			public function _enqueue() {
				...
				//wp_enqueue_script('fusionredux-extension-customizer-js', $this->_extension_url . 'assets/js/customizer.js');
				// Get styles
				...
				do_action( 'fusionredux-enqueue-' . $this->args['opt_name'] );
						...
						foreach ( $section['fields'] as $field ) {
							if ( isset( $field['type'] ) ) {
								...
								if ( ! class_exists( $field_class ) ) {
									$class_file = apply_filters( 'fusionredux-typeclass-load', $this->path . 'inc/fields/' . $field['type'] . '/field_' . $field['type'] . '.php', $field_class );
									if ( $class_file ) {
		...
		function fusionredux_customizer_custom_validation( $field ) {
			return $field;
		}
	} // if
