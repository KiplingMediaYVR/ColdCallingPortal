=== Create DB Tables === 
Contributors: jppreus 
Donate link: http://jppreusdev.com/projects/wordpress-plugins/donate/ 
Tags: database, table, SQL, wpdb, tables, phpMyAdmin 
...
= 1.2.0 =
* Upgrade installs new managemnet features.
* Upgrade is safe and recommended.  

= 1.1.1 =
* Upgrading is safe. Just a minor bug fix to the name field. See changlog for information.
