...
== Changelog == 
= 0.7 [11-07-2017] =
* Fixed : WC Metabox Tab Issue

= 0.6 [07-07-2017] =
* Fixed Issues In Product Meta Box
* Now Redirects Users To Selected Page Only If That Product Has Single Product Checkout Enabled.

= 0.5.1 [27-05-2017] =
* Fixed Minor Issue

= 0.5 [26-05-2017] =
* Fixed Issue (https://github.com/technofreaky/WooCommerce-Single-Product-Checkout/issues/1)
