...
class WooCommerce_Single_Product_Checkout_Settings extends WC_Settings_Page {
	...
	public function __construct() {
		...
		$this->id    = 'wc_scp';
		$this->label = __( 'WC Single Product Checkout', WC_SPC_LANG);
        ...
        if($section == null){
            ...
            $settings = array(
                ...
                array(
                    ...
                    'default'  => __( 'This Product Is Sold Separately. Kindly Complete Your Existing Order.', WC_SPC_LANG),
                    'type'     => 'textarea',
                ...
                array(
                    ...
                    'default'  => __( 'The Product In Cart Has To Be Ordered Separately So. Finish That Order First', WC_SPC_LANG),
                    'type'     => 'textarea',
                    'css'     => 'width:550px; height: 65px;',
