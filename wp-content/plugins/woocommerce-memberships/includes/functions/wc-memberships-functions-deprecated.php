...
/**
 * Returns valid restriction message types.
 *
 * TODO remove this function by version 1.10.0 or higher {FN 2017-03-09}
 *
...
function wc_memberships_get_valid_restriction_message_types() {
	_deprecated_function( 'wc_memberships_get_valid_restriction_message_types()', '1.7.0', 'WC_Memberships_User_Messages::get_default_messages( false )' );
	return wc_memberships()->get_frontend_instance()->get_valid_restriction_message_types();
}


/**
 * Encodes a variable into JSON via wp_json_encode().
 *
 * TODO remove this function by version 1.10.0 or higher {FN 2017-03-09}
 *
 ...
 *
 * TODO remove this function by version 1.11.0 or higher {FN 2017-03-09}
 *
 * @deprecated since 1.8.0
 *
 * @since 1.7.0
