 ...
 * @return null|\WC_Memberships_User_Membership[]|\WC_Memberships_Integration_Subscriptions_User_Membership[] array of user memberships or null if the user is not logged in
 */
 ...
 * @since 1.0.0
 *
 * @return array associative array of statuses and data
 */
 ...
 * @throws \SV_WC_Plugin_Exception may create an exception on errors
