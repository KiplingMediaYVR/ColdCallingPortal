...
abstract class WC_Memberships_Modal {
	...
	protected function get_template_header() {
		...
		<header class="wc-backbone-modal-header">
			...
			<button class="modal-close modal-close-link dashicons dashicons-no-alt">
				<span class="screen-reader-text"><?php esc_html_e( 'Close modal panel', 'woocommerce-memberships' ); ?></span>
			</button>
		</header>
		<?php
	...
	protected function get_template_footer() {
		...
		<footer>
			<div class="inner">
				<button id="btn-ok" class="button button-large <?php echo sanitize_html_class( $this->button_class ); ?>"><?php echo esc_html( $this->button_label ); ?></button>
			</div>
		</footer>
		<?php
